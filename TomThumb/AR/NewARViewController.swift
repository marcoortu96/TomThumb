//
//  NewARViewController.swift
//  TomThumb
//
//  Created by Andrea Re on 24/07/2020.
...
final class NewARViewController: UIViewController, UIViewControllerRepresentable {
    ...
    weak var estHeadingLabel: UILabel!

    var sceneLocationView: SceneLocationView?
    public var demonstration = Demonstration.justOneNode
...
//            addSpriteKitNodes()
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<NewARViewController>) -> NewARViewController {
        
        return NewARViewController()
    }
    
    func updateUIViewController(_ uiViewController: NewARViewController.UIViewControllerType, context: UIViewControllerRepresentableContext<NewARViewController>) {
...
extension NewARViewController: ARSCNViewDelegate {
