...
struct MapRoutesFactory {
    ...
    init() {
        ...
        mapRoutes.append(MapRoute(start: Crumb(location: CLLocationCoordinate2D(latitude: 39.30628322407614, longitude: 8.52236695592103), audio: URL(fileURLWithPath: Bundle.main.path(forResource: "start.m4a", ofType: nil)!)),
        crumbs: [Crumb(location: CLLocationCoordinate2D(latitude: 39.30622863914829, longitude: 8.522427422235353), audio: URL(fileURLWithPath: Bundle.main.path(forResource: "crumb.m4a", ofType: nil)!)), Crumb(location: CLLocationCoordinate2D(latitude: 39.306148711123996, longitude: 8.522515602289701), audio: URL(fileURLWithPath: Bundle.main.path(forResource: "crumb.m4a", ofType: nil)!))],
        finish: Crumb(location: CLLocationCoordinate2D(latitude: 39.306076580873935, longitude:  8.522593704634005), audio: URL(fileURLWithPath: Bundle.main.path(forResource: "finish.m4a", ofType: nil)!))))
